...
#    Updated: 2019/08/29 09:13:02 by gstrauss         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = ft_atoi.c ft_bzero.c ft_isalnum.c ft_isalpha.c ft_isascii.c \
	   ...
	   ft_lstpush.c ft_reorder.c ft_isgreater.c ft_lstcheck.c \
...
OBJS = ft_atoi.o ft_bzero.o ft_isalnum.o ft_isalpha.o ft_isascii.o \
	   ...
	   ft_lstpush.o ft_reorder.o ft_isgreater.o ft_lstcheck.o \
