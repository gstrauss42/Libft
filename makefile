...
#    Updated: 2019/07/17 15:26:04 by gstrauss         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = ft_atoi.c ft_bzero.c ft_isalnum.c ft_isalpha.c ft_isascii.c \
	   ...
	   ft_lstplen.c ft_del.c ft_lstlen.c ft_newlstl.c ft_push_a.c \
	   ft_ra.c ft_rra.c \
...
OBJS = ft_atoi.o ft_bzero.o ft_isalnum.o ft_isalpha.o ft_isascii.o \
	   ...
	   ft_lstplen.o ft_del.o ft_lstlen.o ft_newlstl.o ft_push_a.o \
	   ft_ra.o ft_rra.o \
